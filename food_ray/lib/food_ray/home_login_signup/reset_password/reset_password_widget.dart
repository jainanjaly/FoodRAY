  ...
  Widget build(BuildContext context) {
    ...
    return StreamBuilder<List<UsersRecord>>(
      ...
      builder: (context, snapshot) {
        ...
        List<UsersRecord> resetPasswordUsersRecordList = snapshot.data!;
        final resetPasswordUsersRecord = resetPasswordUsersRecordList.isNotEmpty
                                      ...
                                      Padding(
                                        ...
                                        child: FFButtonWidget(
                                          onPressed: () async {
                                            ...
                                            if (_model.newPasswordTextController
                                                    .text ==
                                                _model
                                                    .confPasswordTextController
                                                    .text) {
                                              ...
                                              if (confirmDialogResponse) {
                                                await resetPasswordUsersRecord!
                                                    .reference
                                                    .update(
                                                ...
                                                await showDialog(
                                                  ...
                                                  builder:
                                                    ...
                                                    return AlertDialog(
                                                      ...
                                                      content: Text(
                                                          'You will be redirected to the login page after this.'),
                                                      actions: [
                                                        TextButton(
                                                          onPressed: () =>
                                                              Navigator.pop(
