...
import 'sign_up_rest_o_t_p_model.dart';
export 'sign_up_rest_o_t_p_model.dart';

class SignUpRestOTPWidget extends StatefulWidget {
  const SignUpRestOTPWidget({super.key});

  static String routeName = 'SignUp_Rest_OTP';
  static String routePath = '/signUpRestOTP';

  @override
  State<SignUpRestOTPWidget> createState() => _SignUpRestOTPWidgetState();
}

class _SignUpRestOTPWidgetState extends State<SignUpRestOTPWidget> {
  late SignUpRestOTPModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => SignUpRestOTPModel());
                        ...
                        onPressed: () async {
                          if (_model.expiryTime! > getCurrentTimestamp) {
                            if (_model.enteredOTP == _model.otp) {
                              context
                                  .pushNamed(SignUpRestDetailsWidget.routeName);
                            } else {
