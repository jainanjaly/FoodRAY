...
import 'rest_activity_model.dart';
export 'rest_activity_model.dart';

class RestActivityWidget extends StatefulWidget {
  const RestActivityWidget({super.key});

  static String routeName = 'rest_activity';
  static String routePath = '/restActivity';

  @override
  State<RestActivityWidget> createState() => _RestActivityWidgetState();
}

class _RestActivityWidgetState extends State<RestActivityWidget> {
  late RestActivityModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => RestActivityModel());
  }
